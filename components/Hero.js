  ...
  return (
    <>
      <div className="max-w mx-auto mt-10 font-semibold">
        <div>
          <p className="max-w-7xl mx-auto text-4xl lg:text-5xl leading-normal lg:leading-normal font-light text-gray-200">
            Hi my name is Can, and I am a Full Stack Developer, Designer and
            Entrepreneur based in Amsterdam. Interests in technology, start-ups,
            music and travel. I specialise in creating beautiful and functional
            interfaces using Vue.js React, Next and other hip frameworks.
          </p>
        </div>
      </div>
      ...
      <div className="mt-20 max-w-7xl mx-auto">
        <p className="max-w-7xl text-4xl lg:text-5xl leading-normal lg:leading-normal font-light text-gray-200">
          If you fancy a chat, feel free to contact me or follow me on social
          media!
        </p>
      </div>
