...
const NewUpdate = () => {
  ...
  return (
    <div className="max-w-3xl xl:mx-48  mt-20 mb-20 sm:mt-24 px-2 justify-center mx-4 text-lg md:text-2xl tracking-loose">
      ...
      <p className="font-light">
        I am a software developer currently based in Amsterdam. Most of my work
        is open source and publicly available on{" "}
        <Link
      ...
      <ul className="mt-10 gap-4">
        ...
        <li>
          <Link href="https://calendly.com/canguden">
            <button className=" py-2 px-4 bg-blue-500 hover:bg-blue-400  text-white text-base md:text-lg duration-300">
              Schedule a meeting
            </button>
          </Link>
        </li>
