    ...
    <div className=" flex flex-row max-w-4xl justify-between  mx-auto font-semibold">
      ...
      >
        <Link href="/pareto-principle" passHref={true}>
          <button className="font-bold text-md lg:text-xl text-black dark:text-white flex mr-3 rounded-lg py-2  ">
            Read more
          </button>
        </Link>
      </motion.div>
      ...
      >
        <Link href="https://ctt.ac/UM87p" target="_blank" passHref={true}>
          <button className=" text-md lg:text-lg text-white flex mr-5  bg-sky-500 rounded-full py-2  px-4">
