  ...
  return (
    <>
      ...
      <div className="mt-20 max-w-7xl mx-auto">
        ...
        Love for Basketball, Art, Chess, Games, Snowboarding, Music, Reading and Travel.
          </p>
        </div>

        <div className="mt-20 max-w-7xl mx-auto">
          <p className="max-w-7xl text-4xl lg:text-7xl leading-normal lg:leading-normal font-light text-gray-200">
        Photoroll Backshots, Greece, Italy, Montenegro & Barcelona
          </p>
        </div>
